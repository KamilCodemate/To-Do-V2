...
public class UpdateSubtaskCompletionController {
    ...
    public ResponseEntity<String> updateSubtaskCompletion(@RequestBody @Valid UpdateSubtaskCompletionModel requestData, @RequestHeader(name = TOKEN_HEADER) String token) throws InvalidTokenException {
